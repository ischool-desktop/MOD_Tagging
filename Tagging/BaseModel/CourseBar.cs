...
{
    internal partial class CourseBar : DescriptionPane
    {
        ...
        public CourseBar()
        {
            ...
            K12.Data.Course.AfterUpdate += Course_AfterUpdate;

            CourseTag.AfterInsert += TagRecordChangedEventHandler;
            CourseTag.AfterUpdate += TagRecordChangedEventHandler;
            CourseTag.AfterDelete += TagRecordChangedEventHandler;
        ...
        private void Course_AfterUpdate(object sender, DataChangedEventArgs e)
        {
        ...
        public List<GeneralTagRecord> SelectTags(string primaryKey)
        {
            ...
            stus = K12.Data.CourseTag.SelectByCourseID(primaryKey);
        ...
        {
            Course.RemoveByIDs(new string[] { primaryKey });
            CourseRecord record = Course.SelectByID(primaryKey);
